if (DEFINED ENV{REDCARPET-S_CLANG})
    set(REDCARPET-S_CLANG "$ENV{REDCARPET-S_CLANG}")
else()
    set(REDCARPET-S_CLANG "${CMAKE_CURRENT_LIST_DIR}/clang-8.0.0")
endif()
...
set(CMAKE_C_COMPILER "${REDCARPET-S_CLANG}/bin/clang")
set(CMAKE_C_COMPILER_TARGET ${NX64_TRIPLE})
set(CMAKE_CXX_COMPILER "${REDCARPET-S_CLANG}/bin/clang++")
